...
(function(global, factory) {
    ...
    var SLIDES_ARROW_PREV =     SLIDES_ARROW + ' ' + SLIDES_PREV + ' mobile';
    if (windowWidth < 700) {
		SLIDES_ARROW_PREV =     SLIDES_ARROW + ' ' + SLIDES_PREV + ' mobile enable';
	}
	var SLIDES_ARROW_PREV_SEL = SLIDES_ARROW_SEL + SLIDES_PREV_SEL;
    var SLIDES_NEXT =           'fp-next';
    var SLIDES_NEXT_SEL =       '.' + SLIDES_NEXT;
    var SLIDES_ARROW_NEXT =     SLIDES_ARROW + ' ' + SLIDES_NEXT + ' mobile';
	if (windowWidth < 700) {
		SLIDES_ARROW_NEXT =     SLIDES_ARROW + ' ' + SLIDES_NEXT + ' mobile enable';
	}
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        $('.mainMenu').on('click', function(e) {
            ...
            var foldName = targetEl.data('menuanchor');
            if(!isScrolling && !options.lockAnchors){
                var section = foldName;
                var slide;
